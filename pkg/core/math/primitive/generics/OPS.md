...
- 🔀 **Multi-threaded Support** - Operation supports both single-threaded and multi-threaded execution (in `st/` subpackage)
- 🔒 **Single-threaded Only** - Operation is single-threaded only (only in main `generics` package)
