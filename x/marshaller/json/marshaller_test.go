...
//go:embed testdata/simple_graph.json
var simpleGraphJSON string

//go:embed testdata/simple_tree.json
var simpleTreeJSON string

//go:embed testdata/decision_tree.json
var decisionTreeJSON string

//go:embed testdata/expression_graph.json
var expressionGraphJSON string
...
func TestGraphRoundTrip(t *testing.T) {
	...
	t.Log("✓ JSON graph round-trip successful")
}
...
func TestTreeRoundTrip(t *testing.T) {
	...
	t.Log("✓ JSON tree round-trip successful")
}
...
func TestDecisionTreeRoundTripWithComputation(t *testing.T) {
	...
	t.Logf("JSON decision tree output:\n%s", buf.String())
	...
	t.Log("✓ JSON decision tree round-trip successful (structure verified)")
}
...
func TestExpressionGraphRoundTripWithComputation(t *testing.T) {
	...
	t.Logf("JSON expression graph output:\n%s", buf.String())
	...
	// For now, we verify the structure is correct
	t.Log("✓ JSON expression graph round-trip successful (structure verified)")
}
...
func TestUnmarshalFromEmbeddedJSON(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			u := NewUnmarshaller()
			var result any
			buf := bytes.NewBufferString(tt.jsonData)
			if err := u.Unmarshal(buf, &result); err != nil {
				t.Fatalf("Unmarshal failed: %v", err)
			}
			tt.verify(t, result)
